...
export const SOURATES_DATA: SourateData[] = [
...
// Al-Fatiha → An-Nas (ordre coranique, sans Ayat Al-Kursi)
export const CORAN_ORDERED = SOURATES_DATA
  .filter(s => s.number !== 1000)
